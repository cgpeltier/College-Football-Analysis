...
Other ideas:
- Dobbins rushing
- Run/pass ratio vs. effectiveness
- Coaching salary vs. performance: https://sports.usatoday.com/ncaa/salaries/
- 2016 Clemson EPA charts
- Alluvial diagram for player positions
...
```{r}
# this code is old -- use pull_talent_year instead
# talent_data <- list.files(pattern = "tal_") %>%
    #map_df(~read_csv(.))
