...
One final thing we can do is to visualize all plays for a specific team. Below is the EPA for every Ohio State play this season, separated by game, with box plots to show the distribution of EPA:
